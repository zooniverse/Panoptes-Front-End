...
apiClient.type('workflows').create
  ...
  tasks: {
    ...
    coolest_point: {
      ...
      tools: [
        {type: 'point', label: 'Coolest point', color: 'blue'}
      ]
    }
  }
...
apiClient.type('subjects').create
  ...
  links:
    workflow: type: 'workflows', id: 'MOCK_WORKFLOW_FOR_AGGREGATE_VIEW'

CLASSIFICATION_LINKS =
  workflow: type: 'workflows', id: 'MOCK_WORKFLOW_FOR_AGGREGATE_VIEW'
  subject: type: 'subjects', id: 'MOCK_SUBJECT_FOR_AGGREGATE_VIEW'
