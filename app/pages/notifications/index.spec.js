...
describe('Notifications', () => {
  ...
  describe('it will display according to user', () => {
    ...
    it('will notify when no notifications present', () => {
  ...
  describe('it correctly display projects', () => {
    beforeEach(() => {
      wrapper = shallow(
  ...
  describe('will open sections correctly', () => {
    ...
    it('will open the active project', () => {
    ...
    it('will keep other projects closed', () => {
