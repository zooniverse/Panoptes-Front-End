...
counterpart.registerTranslations 'en',
  volunteeringPage:
   pageContent: '''
    ...
    To sign up as a beta tester, go to [www.zooniverse.org/settings/email](/settings/email) and tick the box next relating to beta testing. We'll then send you emails when a project is ready to be tested. You can change your email settings any time you want at [same email page](/settings/email) and untick the box.

    ### Volunteer as a Project Moderator
    Volunteer moderators have extra permissions in the Talk boards for a particular project. They help moderate discussions and act as a point of contact for the project and are selected by the project owner. If you're interested in becoming a moderator on a project your'e taking part in, go to the About page and get in touch with the researcher.
