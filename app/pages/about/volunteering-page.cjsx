...
counterpart.registerTranslations 'en',
  volunteeringPage:
   pageContent: '''
    ...
    Volunteer moderators have extra permissions in the Talk discussion tool for a particular project. They help moderate discussions and act as a point of contact for the project. Modeators are selected by the project owner. If you're interested in becoming a moderator on a project your'e taking part in, go to the project's About page and get in touch with the researcher.
