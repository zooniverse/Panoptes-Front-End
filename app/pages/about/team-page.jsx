...
,
            {' '}
            {counterpart(`about.team.content.${member}.title`)}
            {' '}
            {teamMembers[member].twitter ? <a rel="noopener noreferrer" href={`http://twitter.com/${teamMembers[member].twitter}`} target="_blank"><i className="fa fa-twitter" /></a> : null }
          </h3>
