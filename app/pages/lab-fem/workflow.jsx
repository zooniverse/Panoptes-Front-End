...
const WorkflowCreateForm = require('../lab/workflow-create-form');
const workflowActions = require('../lab/actions/workflow');
const classnames = require('classnames');
const FeedbackSection = require('../../features/feedback/lab').default;
const MobileSection = require('../lab/mobile').default;
const SubjectGroupViewerEditor = require('../lab/workflow-components/subject-group-viewer-editor').default;
      ...
      <div className="edit-workflow-page">
        ...
        {this.state.workflowCreationInProgress ?
          <ModalFormDialog tag="div">
            <WorkflowCreateForm onSubmit={this.props.workflowActions.createWorkflowForProject} onCancel={this.hideCreateWorkflow} onSuccess={this.handleWorkflowCreation}  project={this.props.project} workflowToClone={this.props.workflow} workflowActiveStatus={!this.props.project.live} />
