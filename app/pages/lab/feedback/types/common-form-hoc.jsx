...
function returnCommonFormHOC(FeedbackTypeForm) {
  return class CommonFormHOC extends React.Component {
    constructor(props) {
      super(props);
      ...
      this.state = {
        ...
        validations: [
          ...
          (form) => (!form.failureEnabled || (form.failureEnabled && form.defaultFailureMessage && form.defaultFailureMessage.length > 0)),
        ],
      }
    }
