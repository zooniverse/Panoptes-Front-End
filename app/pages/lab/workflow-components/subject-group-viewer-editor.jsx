...
export default class SubjectGroupViewerEditor extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <span className="form-label">Subject Group Viewer Configuration</span>
        <br />
        ...
        {enableSGViewer && (
          <div>
            ...
            <table>
              <tbody>
                <tr>
                  <td><label htmlFor="sgv-config-cell_width">cell_width</label></td>
                  <td>
                    <input id="sgv-config-cell_width" data-configkey="cell_width" value={this.state.cell_width} onChange={this.updateViewerConfig.bind(this)} />
                    {' '}
pixels
                  </td>
                </tr>
                <tr>
                  <td><label htmlFor="sgv-config-cell_height">cell_height</label></td>
                  <td>
                    <input id="sgv-config-cell_height" data-configkey="cell_height" value={this.state.cell_height} onChange={this.updateViewerConfig.bind(this)} />
                    {' '}
pixels
                  </td>
                </tr>
                <tr>
                  <td><label htmlFor="sgv-config-grid_columns">grid_columns</label></td>
                  <td>
                    <input id="sgv-config-grid_columns" data-configkey="grid_columns" value={this.state.grid_columns} onChange={this.updateViewerConfig.bind(this)} />
                    {' '}
cells
                  </td>
                </tr>
                <tr>
                  <td><label htmlFor="sgv-config-grid_rows">grid_rows</label></td>
                  <td>
                    <input id="sgv-config-grid_rows" data-configkey="grid_rows" value={this.state.grid_rows} onChange={this.updateViewerConfig.bind(this)} />
                    {' '}
cells
                  </td>
                </tr>
                <tr>
                  <td><label htmlFor="sgv-config-grid_max_width">grid_max_width</label></td>
                  <td>
                    <input id="sgv-config-grid_max_width" data-configkey="grid_max_width" value={this.state.grid_max_width} onChange={this.updateViewerConfig.bind(this)} placeholder="Optional" />
                    {' '}
CSS units
                  </td>
                </tr>
                <tr>
                  <td><label htmlFor="sgv-config-grid_max_height">grid_max_height</label></td>
                  <td>
                    <input id="sgv-config-grid_max_height" data-configkey="grid_max_height" value={this.state.grid_max_height} onChange={this.updateViewerConfig.bind(this)} placeholder="Optional" />
                    {' '}
CSS units
                  </td>
                </tr>
            ...
            <small className="form-help">Note: as of May 2021, the maximum grid size is 25 cells.</small>
            <br />
            <small className="form-help">Note: grid_max_width and grid_max height are fully optional and used only if users say the grid is "exceeding the visible browser space". (Usually happens with really wide screens.) Either leave blank, or use CSS units, e.g. 1000px or 50vw.</small>
            <br />
