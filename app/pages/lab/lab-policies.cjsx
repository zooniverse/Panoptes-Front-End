...
counterpart.registerTranslations 'en',
  policiesPage:
    content: '''
      ...
      This page is for those who have used the builder tools to construct a project they're happy with,
      and are now ready to launch it to the wider world. The first thing to understand is that there are
      three modes which a live project can be in - _Public Projects_, _Beta Projects_, and _Zooniverse Projects_:
      ...
      button will allow the Zooniverse team to review your project - this is just a quick check to make sure it complies
      with our rules (see below). Once it passes review, it will be available on the beta projects page and accessible
      to volunteers.

      _During the beta phase, you should be checking for suggestions and comments on the project's Discussion pages.
      Technical issues can be reported to us via [the GitHub repository](https://github.com/zooniverse/Panoptes-Front-End), but you will need to consider carefully
      comments on workflow design. Remember to look at the results produced during this beta phase too - are they of
      sufficient quality for your research? If not, then a redesign or a rethink is in order; go back, make changes
      to your project and then submit it for Beta once again._

      Following a successful beta, you should have a final version of the workflow that you're confident will produce
      useful results, and a site containing all the information that volunteers will need. You can then submit your
      project for launch, making it an official **Zooniverse Project** which will appear on our main page. A project
      appearing on the main Zooniverse page must have as its goal the production of useful research, and so
      there will be a further review. This final review may include requesting information from you about your
      plans for using the results, and a review of the beta test results. We may also carry out a peer review
      of your project.
      ...
      Once the project has passed review, it will appear on the main project list, and we will consider it for inclusion
      in a Zooniverse community newsletter or for other promotion. If you want to increase the chance that your project
      will be promoted, then note that we will particularly favour projects whose researchers are proactive in engaging
      ...
      By using the Zooniverse project builder, you're making use of our software and hosting, and so we
      reserve the right to remove content for any reason whatsoever. In particular, we will remove
      content and projects which are brought to our attention and where:
      ...
      subjects, or will have more than a few hundred concurrent users, please let us know. We’re keen to help.
