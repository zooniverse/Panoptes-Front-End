...
*
  ...
  return (
    <div>
      ...
      <p>
        <em>Note</em>
: Please leave at least one active workflow; even if all workflows are 100% complete.
      </p>
      <p>{reorderButton}</p>
...
total number of classifications needed to complete the workflow is estimated assuming a constant retirement limit.
        {' '}
If the retirement limit is changed and/or subjects sets are unlinked from a
        <b>live</b>
        {' '}
workflow this estimate will be inaccurate.
        {' '}
To avoid these issues completed subject sets should not be removed, instead completed workflows should be deactivated
        {' '}
and new ones created for new subject sets (note: workflows can be copied using the
        <i className="fa fa-copy" />
        {' '}
button at the top of a workflow's edit page).
      </p>
      <p className="form-help">
