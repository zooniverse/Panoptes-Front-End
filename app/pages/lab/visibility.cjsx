      ...
      <div style={looksDisabled if @props.project.private or not @props.project.live}>
        ...
        <p>
          ...
          {if @props.project.private
            ...
            <span>Beta status has been applied for. <button type="button" disabled={@state.setting.beta_requested} onClick={@set.bind this, 'beta_requested', false}>Cancel application</button></span>}
        </p>
        ...
        <div style={looksDisabled unless @props.project.beta_approved}>
          ...
          <p>
            ...
            {if @props.project.launch_approved
              ...
              <span>Launch is awaiting Zooniverse approval. <button type="button" disabled={@state.setting.launch_requested} onClick={@set.bind this, 'launch_requested', false}>Cancel application</button></span>}
          </p>
