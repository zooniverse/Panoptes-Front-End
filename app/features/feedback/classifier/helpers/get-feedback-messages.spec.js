...
describe('helpers > open-feedback-modal > getFeedbackMessages', function() {
  ...
  it('should reduce an array of messages to a collection of unique messages with counts. ' +
    'The counts for both message classes should be > 1.',
    function() {
  ...
  it('should reduce an array of messages to a collection of unique messages with counts. ' +
    'The counts for the success message class should be > 1. ' +
