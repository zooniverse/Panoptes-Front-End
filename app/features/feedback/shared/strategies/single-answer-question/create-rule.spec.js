...
describe('Feedback > Single Answer Question > Rule Creator', () => {
  it('should create a rule with `failureEnabled` and `successEnabled` defaulting to false', () => {
  ...
  it('should create a rule with the right properties derived from the workflow', () => {
    const subjectRule = { answer: '1', id: '2' };
    const workflowRule = {
      failureEnabled: true,
  ...
  it('should create a rule with the right properties derived from the subject metadata', () => {
    const subjectRule = { answer: '1', id: '2' };
    const workflowRule = { strategy: '3' };
    const rule = createRule(subjectRule, workflowRule);
  ...
  it('should use the success and failure messages from the subject if available', () => {
    const subjectRule = {
      answer: '1',
  ...
  describe('behaviour when a required property is missing', () => {
    ...
    it('should return an empty object if `answer` is missing', () => {
    ...
    it('should return an empty object if `strategy` is missing', () => {
      const subjectRule = Object.assign({}, BASE_SUBJECT_RULE);
      const workflowRule = Object.assign({}, BASE_WORKFLOW_RULE);
    ...
    it('should return an empty object if failure is enabled and `failureMessage` is missing', () => {
      const subjectRule = Object.assign({}, BASE_SUBJECT_RULE);
      const workflowRule = Object.assign({}, BASE_WORKFLOW_RULE);
    ...
    it('should return an empty object if success is enabled and `successMessage` is missing', () => {
      const subjectRule = Object.assign({}, BASE_SUBJECT_RULE);
      const workflowRule = Object.assign({}, BASE_WORKFLOW_RULE);
