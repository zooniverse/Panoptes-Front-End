...
describe('feedback drawing: lab component', () => {
  ...
  describe('with TextInput', () => {
    ...
    it('should include a TextInput component', () => {
      expect(textInput).to.have.lengthOf(1);
    });

    it('should include the default tolerance', () => {
  ...
  describe('with CheckboxInput', () => {
    ...
    it('should include a CheckboxInput component', () => {
      expect(checkboxInput).to.have.lengthOf(1);
    });

    it('should reflect the hideSubjectViewer value provided', () => {
