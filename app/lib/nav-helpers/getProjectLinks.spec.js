...
describe('getProjectLinks', () => {
  it('should use the project slug in building the navbar links', () => {
  ...
  it('should return about, classify, talk, and collections set of navbar links', () => {
  ...
  describe('with a user', () => {
    it('should return a recents link', () => {
    ...
    it('should not return a lab link if the user is not the project owner or a collaborator', () => {
      const navLinks = getProjectLinks({ project: projectWithoutRedirect, projectRoles, user: randomUser });
      expect(Object.keys(navLinks).indexOf('lab') > -1).to.be.false;
    });

    it('should not return an admin page link if the user is not an admin', () => {
      const navLinks = getProjectLinks({ project: projectWithoutRedirect, projectRoles, user: randomUser });
      expect(Object.keys(navLinks).indexOf('admin') > -1).to.be.false;
    });

    describe('who have a project role', () => {
      it('should return the lab link if the user is the project owner', () => {
        const navLinks = getProjectLinks({ project: projectWithoutRedirect, projectRoles, user: projectOwnerUser });
        expect(Object.keys(navLinks).indexOf('lab') > -1).to.be.true;
      });

      it('should return the lab link if the user is a project collaborator', () => {
        const navLinks = getProjectLinks({ project: projectWithoutRedirect, projectRoles, user: projectCollabUser });
        expect(Object.keys(navLinks).indexOf('lab') > -1).to.be.true;
      });
    });

    describe('who has admin privileges', () => {
      before(() => {
      ...
      it('should return the admin link if the user is an admin', () => {
  ...
  describe('a project with a redirect', () => {
    it('should reset the classify link to the redirected project\'s classify page', () => {
    ...
    it('should not return the about link', () => {
      const navLinks = getProjectLinks({ project: projectWithRedirect, projectRoles, user: randomUser });
      expect(Object.keys(navLinks).indexOf('about') > -1).to.be.false;
    });
  });

  describe('a project with active workflows', () => {
    it('should not disable the classify link', () => {
  ...
  describe('a project without a workflow', () => {
    it('should return the classify link with disabled: true', () => {
      const project = Object.assign({}, projectWithoutRedirect);
