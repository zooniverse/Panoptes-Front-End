export default {
  ...
  privacy: {
    ...
    privacyPolicy: {
      ...
      furtherInfo: '**Further information and requests**\n\nThe Data Controller is the University of Oxford (Chancellor, Masters and Scholars of the University of Oxford). For information and questions regarding this policy and Zooniverse data, please contact the Zooniverse team at [contact@zooniverse.org](mailto:contact@zooniverse.org). Information on your rights, including the right of access, in relation to your personal data are explained here: [http://www.admin.ox.ac.uk/councilsec/compliance/gdpr/individualrights/](http://www.admin.ox.ac.uk/councilsec/compliance/gdpr/individualrights/). If you want to exercise any of the rights or are dissatisfied with the way we have used your information, you should contact the University’s Information Compliance Team at [data.protection@admin.ox.ac.uk](mailto:data.protection@admin.ox.ac.uk).'
    },
    youthPolicy: {
