export default {
  ...
  about: {
    ...
    acknowledgements: {
      ...
      instructions: 'Per the [Zooniverse Project Builder Policies](https://zooniverse.github.io/help/getting-started/lab-policies), all research publications using any data derived from Zooniverse approved projects (those listed on the [Zooniverse Projects page](/projects)) are required to acknowledge the Zooniverse and the Project Builder platform. To do so, please use the following text:',
  ...
  getInvolved: {
    ...
    volunteering: {
      ...
      betaTesterDescription: 'Volunteers also help us test projects before they are launched to check that they work properly. This involves working through some classifications on the beta project to check that it works, looking for any bugs, and filling out a questionnaire at the end. This helps us find any issues in the project that need resolving and also assess how suitable the project is for the Zooniverse. You can read some guidelines on what makes a project suitable on the [Policies](https://zooniverse.github.io/help/getting-started/lab-policies) page, under \'Rules and Regulations\'.',
    ...
    help: {
      howToBuildProject: {
        ...
        quickGuide: {
          ...
          step10: '10. Guidelines on how to design your project to maximize engagement and data quality are provided on the [Policies page](https://zooniverse.github.io/help/getting-started/lab-policies).',
        ...
        navigatingTheProjectBuilder: {
          ...
          glossaryPage: 'For more Zooniverse definitions, check out the [Glossary page](https://zooniverse.github.io/help/getting-started/glossary).'
        },
        project: {
          title: '### Project',
