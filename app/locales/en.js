export default {
  ...
  about: {
    ...
    acknowledgements: {
      ...
      publicationShareForm: 'We strongly encourage project owners to report published accepted research publications using Zooniverse-produced data to us via [this form](https://docs.google.com/forms/d/e/1FAIpQLSdbAKVT2tGs1WfBqWNrMekFE5lL4ZuMnWlwJuCuNM33QO2ZYg/viewform). You can find a list of publications written using the Zooniverse on our [Publications page](https://www.zooniverse.org/about/publications).',
      questions: 'If you have any questions about how to acknowledge the Zooniverse, such as referencing a particular individual or custom code, please [get in touch](https://www.zooniverse.org/about#contact).',
      ...
      enquiries: 'If you are interested in interviewing a member of the team, please [get in touch](https://www.zooniverse.org/about#contact).'
    },
    contact: {
    ...
    faq: {
      ...
      howToAcknowledge: '- **I\'m a project owner/research team member, how do I acknowledge the Zooniverse and the Project Builder Platform in my paper, talk abstract, etc.?**\nYou can find more details on how to cite the Zooniverse in research publications using data derived from use of the Zooniverse Project Builder on our [Resources page](https://www.zooniverse.org/about/resources).',
      browserSupport: '- **What browser version does Zooniverse support?**\nWe support major browsers up to the second to last version.',
      furtherHelp: 'Didn\'t find the answer to your question? Visit the [Zooniverse Solutions webpage](https://zooniverse.freshdesk.com/support/solutions), ask on [Zooniverse Talk](/talk), or [get in touch](https://www.zooniverse.org/about#contact).'
    },
    resources: {
      title: '## Resources',
      ...
      printables: '[Download printable handouts, posters, and other ephemera](https://github.com/zooniverse/Brand/tree/master/style%%20guide/downloads). If you have specific needs not addressed here, please [let us know](https://www.zooniverse.org/about#contact).',
      press: '### Press Information',
      tips: 'Tips for writing about the Zooniverse in the press',
      listOne: '- Please always include URLs when writing about specific projects. If writing generally about the Zooniverse, please include www.zooniverse.org somewhere in your article. Check out the [Resources page](https://www.zooniverse.org/about/resources) for more details about how to correctly acknowledge the Zooniverse.',
      listTwo: '- Please note: we are a platform for people-powered research, not a company or non-profit.',
      listThree: '- If you have questions about the Zooniverse and would like to speak to a member of our team, please [contact us](https://www.zooniverse.org/about#contact).'
    },
    highlights: {
  ...
  getInvolved: {
    ...
    callForProjects: {
      ...
      nasa: {
        ...
        support: 'Whether you are already building workflows using the Project Builder or you are just starting to consider how crowdsourced contributions could advance your research, the Zooniverse team has dedicated effort to support teams during development and implementation of NASA-focused projects. We are happy to discuss and support proposals to NASA citizen science funding calls (including the [Citizen Science Seed Funding Program](https://science.nasa.gov/science-news/citizenscience/nasa-funding-available-for-scientists), the [Citizen Science for Earth Systems Program](https://www.earthdata.nasa.gov/esds/competitive-programs/csesp), and other NASA ROSES funding opportunities) for projects interested in using the Zooniverse platform.',
    ...
    volunteering: {
      ...
      contactUs: 'If you\'d like any more information on any of these different roles, contact us via the [Contact Us](https://www.zooniverse.org/about#contact) page.'
    }
  },
  lab: {
    help: {
