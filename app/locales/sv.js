export default {
  ...
  privacy: {
    title: 'Zooniverse användaravtal och sekretesspolicy',
    userAgreement: {
      summary: '## Användaravtal\n**Sammanfattning**\n\nZooniverse är en samling av medborgarvetenskapliga projekt. Projekten drivs av forskningsgrupper i flera institut som stöder vetenskaplig forskning genom att involvera allmänheten - du - i att analysera och diskutera mätdata. Data från dessa projekt avnänds för att studera teorin om och utformningen av online-communityn, gränssnittsdesign, och andra ämnen. Det här dokumentet beskriver vad som händer med dina bidrag om du väljer att vara med, samt vilka mätdata vi samlar in, hur vi använder dem, och hur vi skyddar dem.',
      contribution: '**Det går du med på om du bidrar till Zooniverse**\n\nProjekt som involverar allmänheten behövs för att forskare ska kunna hantera störtfloder av data som annars skulle vara allt för stora för att hantera. Via nätet får forskarna ett sätt att nå en stor publik som är villig att dela med sig av en del av fritiden för att gynna projekt som ökar vår förståelse för världen och för universum.\n\nProjektets huvudssakliga mål är att göra de data som analyseras tillgängliga för forskarna att använda, modifiera och sprida vidare med målet att främja vetenskaplig forskning. Det betyder att om du bidrar till Zooniverse ger du oss och våra samarbetspartners tillstånd att fritt använda dina bidrag som vi önskar för att uppnå detta mål, och du litar på oss att göra rätt med dina data. Detta tillstånd ger du dock icke-exklusivt, vilket betyder att det är du själv som fortfarande äger ditt bidrag.\n\nVi ber dig att ge oss dessa breda tillstånd därför att de ger oss möjlighet att ändra de juridiska detaljerna som gäller för att kunna göra våra data tillgängliga. Detta är viktigt eftersom de juridiska ramarna kan ändras och i så fall behöver vi kunna svara på eventuella ändringar utan att behöva få tillstånd från var och en som bidrar.\n\nAvslutningsvis ska du inte bidra med data till Zooniverse som du inte äger. Kopiera till exempel inte information från publicerade forskningsartiklar. Om någon gör detta kan det innebära stora juridiska huvudvärk för oss.',
      data: '**Det får du göra med data från Zooniverse**\n\nDu bibehåller ägandeskap av alla bidrag som du gör till Zooniverse, och allt som sparas när du interagerar med datamängderna som är förknippade med Zooniverse. Du får använda, sprida eller ändra ditt eget bidrag som du önskar. Du äger däremot inte själva datamängden. Detta avtal gäller inte data om dig själv, vilket täcks av sekretessavtalet.',
  ...
  about: {
    index: {
      ...
      nav: {
        ...
        faq: 'Vanliga frågor',
        resources: 'Resurser',
        highlights: 'Bok med höjdpunkter',
        donate: 'Donera'
      }
    },
    home: {
    ...
    contact: {
      ...
      discussionBoards: 'Det bästa sättet att komma i kontakt med Zooniverse-teamet, eller något av projektlagen, är genom våra diskussionsforum.',
      email: 'Om du behöver kontakta Zooniverse-teamet om något allmänt, skicka epost på engelska till [contact@zooniverse.org](mailto:contact@zooniverse.org). Tänk på att teamet är litet och har mycket att göra. Därför kan vi inte svara på alla de mejl som vi får.',
      collaborating: 'Om du vill samarbeta med Zooniverse, t ex med att bygga ett samarbetsprojekt, skicka epost till [collab@zooniverse.org](mailto:collab@zooniverse.org). (Obs! Med vårt [Project Builder](/lab) får du ett effektivt sätt att komma igång med ett nytt projekt utan att behöva ta kontakt med teamet.)',
      pressInquiries: 'Pressförfrågningar ska gå till Zooniverse föreståndare Chris Lintott [chris@zooniverse.org](mailto:chris@zooniverse.org), +44 (0) 7808 167288 eller Laura Trouille, [trouille@zooniverse.org](mailto:trouille@zooniverse.org), +1 312 322 0820.',
      dailyZoo: 'För att hålla dig uppdaterad om vad som händer och våra senaste resultat, kolla [Daily Zooniverse](http://daily.zooniverse.org/) eller [Zooniverse-bloggen](http://blog.zooniverse.org/). Du kan även följa Zooniverse på [Twitter](http://twitter.com/the_zooniverse), [Facebook](http://facebook.com/therealzooniverse), och [Google+](https://plus.google.com/+ZooniverseOrgReal).'
    },
    faq: {
    ...
    donate: {
      title: '## Stöd Zooniverse',
      paragraphOne: 'Zooniverse är ett samarbete mellan University of Oxford, Adler Planetarium i Chicago, University of Minnesota – Twin Cities (UMN), hundratals forskare och fler än 2 miljoner deltagare från hela världen. I [Zooniverse-teamen](https://www.zooniverse.org/about/team) i Oxford, på Adler och på UMN ingår projektledarna, webbutvecklare, formgivare, kommunikatörer och forskare. Denna unika blandning av expertis inom forskning, forskningskommunikation och modern webbutveckling stöttar ett otroligt community av frivilliga och dedikerade forskarlag som använder Zooniverse-plattformen.',
      paragraphTwo: 'En avsevärd del av det ekonomiska stödet för Zooniverse är från forskningsanslag, tillsammans med stöd från Oxford, Adler och UMN.',
      paragraphThree: 'Du kan ge pengar till Adler Planetarium i Chicago. Din gåva gör det möjligt för forskare att göra sina data tillgängliga genom medborgarforskningsprojekt, samt många andra utåtriktade projekt i Chicago med omnejd.',
      paragraphFour: 'Följ länken nedan för att ge en gåva på Adler Planetariums hemsida.'
    }
  },
  getInvolved: {
    index: {
