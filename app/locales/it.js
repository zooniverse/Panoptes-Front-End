export default {
  ...
  privacy: {
    title: 'Accordo con gli utenti e Politica sulla privacy di Zooniverse',
    userAgreement: {
  ...
  emailSettings: {
    ...
    talk: {
      ...
      options: {
        participating_discussions: 'Quando discussioni a cui partecipo sono aggiornate',
        followed_discussions: 'Quando discussioni che seguo sono aggiornate',
