export default {
  ...
  privacy: {
    title: 'Accordo con gli utenti e Informativa sulla privacy di Zooniverse',
    userAgreement: {
  ...
  about: {
    ...
    publications: {
      ...
      publication: {
        ...
        viewOpenAccess: 'Leggi versione in open access.'
      }
