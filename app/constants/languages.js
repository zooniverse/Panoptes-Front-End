const languages = [
  ...
  { value: 'xh', label: 'isiXhosa (South Africa)' },
  { value: 'zu', label: 'isiZulu (South Africa)' },
  ...
  { value: 'nso', label: 'Sesotho sa Leboa (South Africa)' },
  { value: 'tn', label: 'Setswana (South Africa)' },
