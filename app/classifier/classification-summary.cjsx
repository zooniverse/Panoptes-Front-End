    ...
    <div className="classification-summary">
      {if @props.classification.annotations.length is 0
        ...
        for annotation in @props.classification.annotations
          ...
          SummaryComponent = if annotation.value['skipped'] then tasks['nothingHere'].Summary else tasks[task.type].Summary # TODO: There's a lot of duplicated code in these modules.
