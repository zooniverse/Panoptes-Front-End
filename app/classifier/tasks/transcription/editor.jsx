    ...
    <div className={`workflow-task-editor ${task.type}`}>
      ...
      <div>
        ...
        <small className="form-help">
          ...
          <dl>
            <dt>
              <img src="https://via.placeholder.com/10x10.png/06FE76?text=+" />
              {' '}
Green
            </dt>
            <dd>A transcription line mark currently selected by the volunteer.</dd>
            <dt>
              <img src="https://via.placeholder.com/10x10.png/235DFF?text=+" />
              {' '}
Blue
            </dt>
            <dd>A transcription line mark made by the volunteer.</dd>
            <dt>
              <img src="https://via.placeholder.com/10x10.png/FF40FF?text=+" />
              {' '}
Pink
              {' '}
            </dt>
            ...
            <dt>
              <img src="https://via.placeholder.com/10x10.png/979797?text=+" />
              {' '}
Gray
            </dt>
