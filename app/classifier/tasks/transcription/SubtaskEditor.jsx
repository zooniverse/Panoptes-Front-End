  ...
  return (
    <div className="text-editor">
      <section>
        ...
        <br />
        <span className="form-label">Metadata Tags</span>
        {' '}
        <br />
        <small className="form-help">Volunteers can attach the following tags to highlighted portions of their transcription.</small>
        <br />
        <label>
