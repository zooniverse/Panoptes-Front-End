...
const EditorHelp = {
  ...
  options: <div className="content-container">
    <p>
Add an option label individually
      <strong>OR</strong>
      {' '}
copy and paste a list of option labels,
      <em>NO</em>
      {' '}
header, and click the &apos;Add&apos; button. An example of a list of option labels is as follows:
    </p>
