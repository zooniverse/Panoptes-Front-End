#Creates an ellipes in the center of the image during the first click, and does not allow it to be dragged
React = require 'react'
...
module.exports = createReactClass
  displayName: 'AnchoredEllipseTool'
