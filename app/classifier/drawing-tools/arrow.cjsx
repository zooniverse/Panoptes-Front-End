...
module.exports = React.createClass
  ...
  render: ->
    ...
    deleteButtonPostion = { x: x1 + DELETE_TOOL_PERPENDICULAR_OFFSET*lineperpunit[0]/scaleFactor,
    y: y1 + DELETE_TOOL_PERPENDICULAR_OFFSET*lineperpunit[1]/scaleFactor}
