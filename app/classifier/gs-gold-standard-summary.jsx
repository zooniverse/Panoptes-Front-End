...
const GSGoldStandardSummary = ({ classification, subject, workflow }) => {
  ...
  classification.annotations
    .filter(annotation => workflow.tasks[annotation.task].type === 'survey')
    .forEach((annotation) => {
  ...
  const isMatch = choiceLabels.every(label => label === subject.metadata['#Label']);
  ...
  if (isMatch) {
    return (
      <div>
        <p>Good work!</p>
        <p>
When our experts classified this image,
          <br />
they also thought it was a
          {subject.metadata['#Label']}
!
        </p>
...
When our experts classified this image,
        <br />
they labeled it as a
        {subject.metadata['#Label']}
.
      </p>
      <p>
Some of the glitch classes can look quite similar,
        <br />
so please keep trying your best.
      </p>
