...
function PFEProjectRoute() {
  return (
    <div>
      &lt;PFEProjectRoute&gt; elements are for configuration only and should not be
      rendered
    </div>
  );
}
...
PFEProjectRoute.createRouteFromReactElement = (element, parentRoute) => {
  ...
  const pfeProjectRoute = createRoutesFromReactChildren(
    <Route path={path} component={require('./pages/project').default}>
  ...
  pfeProjectRoute.component = ({ children }) => (
    <div>
      Loading…
