...
export const SLUGS = [
  ...
  'nathanielstarkman/stellar-stream-identification',
  'ywyh/delve-dwarf-galaxy-quest-milky-way-neighbors',
  'iascsearch/iascs-asteroid-search',
  'boomer3/supernova-host-herding',
  'karim-gh/arbor-geo-frame',
  'ebellm/rubin-difference-detectives',
  'blacksquirrel/giant-tortoise-initiative',
  'skeogh17/snail-scribe-archive',
  'bofosubamfo/ghanaphenopulse',
  'wildintel/european-camera-trap-project',
  ...
  'jaybirddccb/snapshot-dubuque-iowa',
  'sumbredolphin/dolphin-spotting',
